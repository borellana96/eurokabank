...
class MenuPage extends StatelessWidget {
                ...
                children: <Widget>[
                  ...
                  Container(
                    child: Row(
                      ...
                      children: <Widget>[
                        botonServicio(Icons.favorite, "Aperturar Cuenta"),
                        botonServicio(Icons.face, "Ver Perfil"),
                      ],
                    ),
                  ),
                  Container(
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceAround,
                      children: <Widget>[
                        botonServicio(Icons.cancel, "Cancelar Cuenta"),
                        botonServicio(Icons.sync, "Transferir Dinero"),
                      ],
                    ),
                  ),
                ],
  ...
  Widget botonServicio(IconData icon, String tituloBoton) {
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Text(tituloBoton, textAlign: TextAlign.center, style: TextStyle(fontSize: 11))
        ],
      ),
    );
  }
        ...
        rows: const <DataRow>[
          DataRow(
            cells: <DataCell>[
              ...
              DataCell(Text('Apertura de Cuenta',style: TextStyle(fontSize: 11))),
